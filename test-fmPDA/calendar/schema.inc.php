...
// Scripts
define('FM_PROJECT_CLICK_SCRIPT',      'PHP_ProjectClick');


// Layouts
define('FM_PROJECT_LAYOUT',            'PHP_Project');
define('FM_PHASE_LAYOUT',              'PHP_Phase');
define('FM_HOLIDAY_LAYOUT',            'PHP_Holiday');
